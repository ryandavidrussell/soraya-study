...
def record_study_turn(
    ...
    signals: dict | None = None, # Ledger signal payload from dataclasses.asdict(UpdateSignals)
) -> None:
    """
    ...
    Attribute alignment (verify against your ledger.py / soraya_gates.py):
        ...
        signals                 → plain dict from dataclasses.asdict(UpdateSignals),
                                  NOT the UpdateSignals object itself. app.py is
                                  responsible for the conversion before calling
                                  this function.
